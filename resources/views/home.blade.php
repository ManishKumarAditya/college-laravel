    ...
    <div class="row">
        <div class="col-lg-3">
            <div class="list-group mt-5">
                <a href="" class=" list-group-item list-group-item-action bg-danger text-white"> Categories of  colleges</a>
                ...
                <a href="" class="list-group-item list-group-item-action bg-dark text-white">Technical Institutes and Professional Schools</a>
                <a href="" class="list-group-item list-group-item-action bg-dark text-white">Technical Institutes and Professional Schools</a>
                <a href="" class="list-group-item list-group-item-action bg-dark text-white">Technical Institutes and Professional Schools</a>
            </div>
        </div>
        <div class="col-lg-9">
            @foreach ($data as $c)
            <div class="card mt-3">
                <div class="card-header bg-warning text-center"><h4 class=""><i>{{$c->college_name}}</i></h2></div>
                <div class="card-body bg-secondary">
                    <img src="{{asset('images/'.$c->image)}}" alt="" width="300px" height="280px" class="float-right">
                    <div class="mt-5 ml-5 text-white">
                        <b> <h5 class="lead text-warning"><b>{{$c->type}}</b></h5></b>
                        ...
                        <hr>
                        <h6 class="lead"><h4 class="text-warning">Dscription:-</h4>{{$c->description}}</h6>
                        <hr>
                    ...
                    <div class="text-center">
                        <a href="{{route('show')}}" class="btn btn-danger">View Details</a>
                    <a href="" class="btn btn-danger">Apply For</a>
                    <a href="" class="btn btn-danger">Ranking</a>
